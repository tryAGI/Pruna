...
{
    private const string UserSecretsId = "Pruna.CLI";
    private const string UserSecretApiKeyName = "PRUNA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"PRUNA_API_KEY"];
    private const string CredentialFileDirectoryName = ".pruna";

    public static async global::System.Threading.Tasks.Task<global::Pruna.PrunaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Pruna.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Pruna.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::Pruna.PrunaClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Pruna.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Pruna.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Pruna.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Pruna.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("PRUNA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Pruna.ApiException exception)
    {
        var builder = new StringBuilder();
