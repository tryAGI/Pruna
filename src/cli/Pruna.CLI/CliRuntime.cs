...
internal static class CliRuntime
{
    ...
    public static async Task<global::Pruna.PrunaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Pruna.ApiException exception)
    {
        var builder = new StringBuilder();
