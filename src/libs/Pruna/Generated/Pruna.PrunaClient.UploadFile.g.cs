...
namespace Pruna
{
    public partial class PrunaClient
    {
        ...
        private static readonly global::Pruna.EndPointSecurityRequirement s_UploadFileSecurityRequirement0 =
        ...
        private static readonly global::Pruna.EndPointSecurityRequirement[] s_UploadFileSecurityRequirements =
            new global::Pruna.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Pruna.FileObject> UploadFileAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pruna.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pruna.AutoSDKHttpResponse<global::Pruna.FileObject>> UploadFileAsResponseAsync(
        ...
        public async global::System.Threading.Tasks.Task<global::Pruna.FileObject> UploadFileAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Pruna.UploadFileRequest
            {
                Content = content,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Pruna.UploadFileRequest
            {
                    ...
                    await global::Pruna.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Pruna.FileObject.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Pruna.FileObject.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
