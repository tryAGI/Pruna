...
namespace Pruna
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Pruna.AutoSDKRetryOptions Retry { get; set; } = new global::Pruna.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Pruna.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Pruna.IAutoSDKHook>();
        ...
        public global::Pruna.AutoSDKClientOptions AddHook(
            global::Pruna.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Pruna.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Pruna.AutoSDKClientOptions UseAuthorizationProvider(
            global::Pruna.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Pruna.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Pruna.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Pruna.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Pruna.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Pruna.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Pruna.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Pruna.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Pruna.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Pruna.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Pruna.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Pruna.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Pruna.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Pruna.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Pruna.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Pruna.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Pruna.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Pruna.AutoSDKClientOptions clientOptions,
            global::Pruna.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Pruna.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Pruna.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Pruna.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Pruna.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Pruna.IAutoSDKHook, global::Pruna.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Pruna.AutoSDKHookContext context)
        {
